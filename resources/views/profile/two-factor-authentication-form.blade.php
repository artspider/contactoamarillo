<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Obtenga seguridad adicional usando autenticación de dos factores.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4 max-w-xl text-sm text-gray-600">
            <p class="font-semibold">
                {{ __('La autenticación de dos factores está habilitada. Escanee el siguiente código QR utilizando la aplicación de autenticación de su teléfono.') }}
            </p>
        </div>
