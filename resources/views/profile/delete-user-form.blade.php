<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Eliminar permanente su cuenta.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('¿Esta seguro de que desea eliminar su cuenta? Hecho esto, todos sus recursos y datos se eliminarán permanentemente. Ingrese su contraseña para confirmar que desea eliminar permanentemente su cuenta.') }}
