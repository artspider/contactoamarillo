<div>
    ...
    <x-employer.container>
        <div id="divDeleteWhenSearch" class="flex flex-col items-center justify-center md:flex-row">
            ...
            <h1 class="font-bold text-lg text-center sm:text-xl xl:w-96 xl:text-2xl 2xl:text-3xl">Tenemos muchos expertos esperando por tu idea para volverla realidad!</h1>
        </div>
    </x-employer.container>
</div>