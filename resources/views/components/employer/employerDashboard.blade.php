                    ...
                    <x-employer.container>
                        <x-employer.section>
                            <div class="flex justify-between items-center">
                                <h2 class="font-bold text-2xl mt-8 mb-5 text-center lg:text-left">Todas nuestras categorias</h2>
                                <a href="{{ url('/categorias') }}" class="text-blue-400 mt-8 mb-5 border-b hover:text-blue-600 hover:border-b hover:border-blue-600">Ver lista</a>
                            </div>
                                ...
                                <x-employer.sliderWrapper class="h-432">
                                    ...
                                    <x-employer.sliderItem2 id="1">
                                        <x-slot name="imgSource">
                                            https://images.unsplash.com/photo-1579017308347-e53e0d2fc5e9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80
                                        </x-slot>
                                    ...
                                    <x-employer.sliderItem2 id="3php ">
                                        <x-slot name="imgSource">
                                    ...
                                    <x-employer.sliderItem2 id="2">
                                        <x-slot name="imgSource">
                                            https://images.unsplash.com/photo-1563126153-74b8e04c1070?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80
                                        </x-slot>
