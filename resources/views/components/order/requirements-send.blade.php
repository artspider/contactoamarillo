<div class="flex items-center">
    <div class="rounded-full bg-blue-200 mr-4">
        <svg class="w-8 h-8 m-2 p-1 fill-current text-blue-600 " xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
            clip-rule="evenodd">
            <path
    ...
    <p class="text-gray-900 text-base font-bold tracking-wide">Has enviado los requisitos </p>
