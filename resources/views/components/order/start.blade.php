<div class="flex items-center">
    <div class="rounded-full bg-green-200 mr-4">
        <svg class="w-8 h-8 m-2 p-1 fill-current text-green-600 " xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24">
            <path
    ...
    <p class="text-gray-900 text-base font-bold tracking-wide">Tu orden se ha iniciado </p>
