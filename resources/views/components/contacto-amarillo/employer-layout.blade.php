...
<body class="bg-light-back  min-h-full antialiased leading-none relative ">
  <x-employer.headerEmployer>
    <x-layouts.menu>
      ...
      <x-contacto-amarillo.contacto-menuitem
        class="pt-3 hover:border-solid hover:border-b hover:border-t hover:border-gray-600 " routeInMenu="dashboard">
        <x-slot name="image">
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Bolsa de trabajo</p>
      </x-contacto-amarillo.contacto-menuitem>
      @endrole
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Publicar proyecto</p>
      </x-contacto-amarillo.contacto-menuitem>
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Proyectos</p>
      </x-contacto-amarillo.contacto-menuitem>
      @endrole
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Habilidades</p>
      </x-contacto-amarillo.contacto-menuitem>
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Servicios</p>
      </x-contacto-amarillo.contacto-menuitem>
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Educación</p>
      </x-contacto-amarillo.contacto-menuitem>
      @endrole
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Buscar experto</p>
      </x-contacto-amarillo.contacto-menuitem>
      @endrole
      ...
      <x-contacto-amarillo.contacto-menuitem class="border-solid hover:border-b hover:border-t hover:border-gray-600 "
        ...
        <p class="text-sm ml-4">Cuenta</p>
      </x-contacto-amarillo.contacto-menuitem>

      <!-- Logout -->
      <div
        class="bg-main-yellow text-black hover:bg-black hover:text-white pl-6 py-2 border-gray-600 hover:border-gray-600 border-solid border-b ">
  ...
  <div class=" min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow">
      <div class="max-w-7xl mt-24 mx-auto py-6 px-6">
        {{ $header }}
      </div>
    </header>
    @endif
