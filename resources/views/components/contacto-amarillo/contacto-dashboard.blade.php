<x-layouts.master title="Dashboard">
  <x-slot name="header">
    <div class="flex justify-between items-center">
      ...
      <x-searchComp placeholder="Buscar proyectos" />
    </div>
  </x-slot>
  ...
  <div class="lg:grid lg:grid-cols-10 lg:gap-4  max-w-7xl px-6 my-4 mx-auto">
    ...
    <div
      ...
      <div class="text-2xl font-bold my-12 text-main-yellow lg:text-4xl ">
        <p>Hola<span class="block"> J. Carlos
      ...
      <div>
        <div><img class="h-16 w-16 rounded-full lg:h-20 lg:w-20" src="https://randomuser.me/api/portraits/men/75.jpg">
        </div>
      </div>
    </div>
    ...
    <div class="md:col-span-4  h-60 text-black mb-5 ">
      <p class="text-lg lg:text-xl font-bold mb-2 ">Your projects</p>
