      ...
      <x-contacto-amarillo.contacto-container>
        <div class="service lg:col-span-5  ">
          ...
          <div class="carousel h-96"
            data-flickity='{"setGallerySize": false,  "imagesLoaded": true, "percentPosition": false, "watchCSS": true }'>
            @forelse ($service->imagenes as $imagen)
            <a href="#" class="carousel-cell-serv  border-gray-400 h-full my-4 ml-3 mr-3 hover:bg-gray-50">
              <div class=" w-full h-84 flex flex-row">
                <img class="h-84 w-full block bg-no-repeat bg-cover rounded-t-lg "
                  src="{{ asset('storage/' . $imagen->ruta )}}" alt="{{$imagen->id}}" />
              </div>
