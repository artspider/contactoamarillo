      ...
      <div
        ...
        <div @click.away="smodal = false" class=" w-full md:w-1/2 border-solid border-4 border-main-yellow fixed">
          <div class="modal--header bg-main-yellow px-4 py-3 flex items-center ">
            ...
            <p class="text-gray-700 font-bold text-lg">Proyecto cread0</p>
          </div>
          <div class="modal--body bg-white w-full flex p-4">
            <p class="text-gray-700 font-semibold tracking-wider leading-relaxed">
              ¡Tu proyecto ha sido creado! Se ha enviado a la bolsa de trabajo del grupo de expertos de
              ContactoAmarillo, donde podran verlo y postularse para llevarlo a cabo.
            </p>
          </div>
      ...
      <x-contacto-amarillo.contacto-card grid="col-span-6">
        ...
        <div class="mt-4 flex flex-col justify-between">
          ...
          <div class="mt-2 relative items-center border border-gray-900 focus:border-transparent w-1/4">
            ...
            focus:ring-2 focus:ring-yellow-300 focus:outline-none focus:shadow-none focus:border-0 focus:bg-transparent" type="number" min="5"
