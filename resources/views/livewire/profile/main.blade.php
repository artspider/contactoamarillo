        ...
        <div class="lg:col-span-3 row-span-6">
          ...
          <div class="bg-white w-10/12 rounded-md shadow-md pb-2 mb-8">
            <div class="relative">
              ...
              <div x-on:click="expertmodal=true" class="absolute top-2 right-2 cursor-pointer">
                <x-icons.edit
          ...
          <div class="mt-8 lg:mt-14 w-full ">
            ...
            <table class="border-collapse w-full">
              <thead>
                <tr>
                  <th
                    class="p-3 font-bold uppercase text-black bg-main-yellow border border-gray-300 hidden lg:table-cell">
                    Certifiación
                  </th>
                  <th
                    class="p-3 font-bold uppercase text-black bg-main-yellow border border-gray-300 hidden lg:table-cell">
              ...
              <tbody>
                ...
                <tr
                  ...
                  <td
                    ...
                    <span
                      class="rounded bg-red-400 py-1 px-3 text-xs font-bold">{{$certification->anio_de_emision}}</span>
                  </td>
                </tr>
                @empty
