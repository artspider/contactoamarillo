...
<div class="flex flex-col  lg:w-96 bg-white rounded-3xl shadow-lg ">
    ...
    @endisset
    @empty($recommendedProject)
    <div class="w-full mx-auto px-6 py-4">
        <h2 class="text-lg font-bold"><a href="/profile">Necesitas actualizar tu perfil</a> </h2>
        <div>
            <svg class="w-32 h-30 fill-current text-center" id="a606ce14-7cf3-4e8b-a3fa-cb9b0e3d5e37"
                data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 649 599.75899">
                <path d="M866.76981,630.62241l-52.6832-78.2546s79.78463,27.85334,70.72994,78.2546Z"
                ...
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" fill="#e5e5e5" />
                <circle cx="105.5315" cy="315.00156" r="10.00001" fill="#d6d637" />
                <circle cx="100.57935" cy="401.00158" r="10" fill="#d6d637" />
                <path
                ...
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" fill="#e5e5e5" />
                <path d="M923.5,632.62241h-647a1,1,0,0,1,0-2h647a1,1,0,0,1,0,2Z" transform="translate(-275.5 -150.1205)"
                    fill="#cbcbcb" />
                <polygon points="409.792 528.602 401.611 549.895 315.587 528.472 327.661 497.045 409.792 528.602"
                    fill="#ffb7b7" />
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" fill="#2f2e41" />
                <path
                ...
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" opacity="0.1" style="isolation:isolate" />
                <path
                ...
                <circle cx="613.28588" cy="315.52409" r="43.50039"
                    transform="translate(-318.98195 375.95297) rotate(-45)" fill="#ffb7b7" />
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" fill="#2f2e41" />
                <rect x="291.58661" y="229.50155" width="87" height="105" fill="#d6d637" />
                <polygon points="296.381 527.602 304.563 548.895 390.587 527.472 378.512 496.045 296.381 527.602"
                    fill="#ffb7b7" />
                <path
                ...
                <path d="M537.08661,446.62241l1.20092-9.27026s44.79908,3.27026,37.79908,14.27026-24,12-24,12Z"
                    transform="translate(-275.5 -150.1205)" fill="#2f2e41" opacity="0.17" />
                <path
                ...
                <path
                    ...
                    transform="translate(-275.5 -150.1205)" fill="#e5e5e5" /></svg>
